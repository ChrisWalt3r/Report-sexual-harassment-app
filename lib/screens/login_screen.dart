...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      if (_selectedLoginMethod == LoginMethod.phone) {
  ...
  Future<void> _handleForgotPassword() async {
    if (_selectedLoginMethod == LoginMethod.phone) {
      await _handleForgotPasswordByPhone();
      return;
    }
  ...
  Future<void> _handleForgotPasswordByPhone() async {
    final isDark = Theme.of(context).brightness == Brightness.dark;
      ...
      builder: (dialogContext) {
        ...
        return AlertDialog(
          ...
          title: Row(
            children: [
              Container(
                ...
                child: Icon(Icons.phone, color: AppColors.royalBlue, size: 24),
              ),
              const SizedBox(width: 12),
              const Text(
                'Reset Password',
          ...
          content: Column(
            ...
            children: [
              Text(
                'Enter the phone number linked to your account and we\'ll send the reset link to its email address.',
                style: TextStyle(
                  fontSize: 14,
                  height: 1.5,
                  color: AppColors.textSecondary,
              ...
              IntlPhoneField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.phone, color: AppColors.royalBlue),
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12),
                    borderSide: const BorderSide(color: AppColors.primaryGreen),
                  ),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                final phoneValue = completePhoneNumber.trim();
    ...
    completePhoneNumber = result.trim();
    ...
    try {
      final email = await _authService.resetPasswordByPhone(
        completePhoneNumber,
      );
            ...
            (context) => AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(
                    'Please check the inbox linked to this phone number and follow the instructions to reset your password.',
                    style: TextStyle(
                      fontSize: 14,
                      height: 1.5,
                      color: AppColors.textSecondary,
                ...
                child: Column(
                  children: [
                        ...
                        children: [
                          Expanded(
                            child: _buildLoginMethodButton(
                              ...
                              selected:
                                  _selectedLoginMethod == LoginMethod.email,
                              onTap: () {
                                setState(() {
                                  _selectedLoginMethod = LoginMethod.email;
                                });
                          ...
                          Expanded(
                            child: _buildLoginMethodButton(
                              ...
                              selected:
                                  _selectedLoginMethod == LoginMethod.phone,
                              onTap: () {
                                setState(() {
                                  _selectedLoginMethod = LoginMethod.phone;
                                });
                    ...
                    Form(
                      ...
                      child: Column(
                        children: [
                          if (_selectedLoginMethod == LoginMethod.email) ...[
                            // Email field
                            CustomTextField(
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Google Sign-In temporarily unavailable. Please use email sign-in.',
            ),
