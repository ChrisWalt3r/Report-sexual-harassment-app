...
import 'package:report_harassment/utils/user_role_utils.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    if (_fullNameController.text.trim().isEmpty ||
        ...
        (UserRoleUtils.shouldShowFaculty(_selectedRole) &&
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      if (!UserRoleUtils.shouldShowStudyLevel(value)) {
                        _selectedStudyLevel = null;
                      }
                ...
                if (_selectedRole == UserRoleUtils.otherRoleValue) ...[
                  ...
                  CustomTextField(
                    ...
                    hint: 'e.g. Cleaner, Electrician, Security, Cook',
                ...
                CustomTextField(
                  ...
                  label: UserRoleUtils.displayIdLabel(_selectedRole),
                  hint: UserRoleUtils.displayIdHint(_selectedRole),
                ...
                if (UserRoleUtils.shouldShowFaculty(_selectedRole)) ...[
                  ...
                  if (_selectedFaculty != null) ...[
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items:
                          (_facultyDepartments[_selectedFaculty] ?? []).map((
                            dept,
                          ) {
                            return DropdownMenuItem(
                              value: dept,
